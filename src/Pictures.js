...
class Pictures extends Component {
  ...
  constructor() {
    ...
    this.loadMorePhotos = this.loadMorePhotos;
  }
  ...
  loadMorePhotos (e) {
    ...
    $.ajax({
      url: 'https://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos&api_key=152a216d6abe1226244dc61bb0992439&photoset_id=72157672679560685&user_id=144523740@N02&format=json&per_page=21&page='+this.state.pageNum+'&extras=url_o,url_m,url_l,url_c',
      dataType: 'jsonp',
